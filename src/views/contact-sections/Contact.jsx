      ...
      <div className="section section-contact-us text-center">
        <Container>
          <Row className="align-items-stretch">
            {" "}
            {/* Add this class */}
            <Col lg="4" className="d-flex flex-column mb-4 mb-lg-0">
                  ...
                  <div className="team-player">
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <Button
                        ...
                        target="_blank"
                      >
                        <i className="now-ui-icons location_map-big mr-2" />{" "}
                        Open Map
                      </Button>
                    </div>
                  </div>
                ...
                <CardBody>
                  <div className="team-player">
                    ...
                    <p className="description text-justify">
                      ...
                      any of the buttons below, as we're here to assist you with
                      anything you need.
                    </p>
                    <div className="d-flex flex-column">
                      <Button
